...
## Corpus Check
- 55 files · ~207,272 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 345 nodes · 320 edges · 103 communities (37 shown, 66 thin omitted)
...
10. `../components/sections/FacebookiSektsioon.astro` - 6 edges
...
Cohesion: 0.18
Nodes (13): CachedScheduleItem, DATE_COLUMN_CANDIDATES, findColumn(), findDateColumn(), formatDate(), getServiceScheduleItems(), MONTHS, parseCsv() (+5 more)
...
## Knowledge Gaps
- **173 isolated node(s):** `name`, `type`, `version`, `node`, `sync` (+168 more)
