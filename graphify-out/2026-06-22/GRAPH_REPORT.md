# Graph Report - keila.advent.ee  (2026-06-22)

## Corpus Check
- 59 files · ~209,554 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 371 nodes · 346 edges · 107 communities (41 shown, 66 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac58b082`
...
1. `../../components/PeaMeta.astro` - 19 edges
2. `../../components/Pais.astro` - 13 edges
3. `Keila Adventkogudus Project README` - 13 edges
...
9. `Jaanipäeva laulud` - 7 edges
10. `Jaanipäeva laulud` - 7 edges
...
Cohesion: 0.22
Nodes (8): buttonSchema, collections, contact, koduleht, laul, laulud, sermons, site
...
Cohesion: 0.25
Nodes (7): 10 000 Põhjust (10 000 Reasons), Halleluuja, Jaanipäeva laulud, Jeesus, Sina valitsed siin paigas, Lootus, Ma tänan sind, Veere, päike!
...
## Knowledge Gaps
- **192 isolated node(s):** `name`, `type`, `version`, `node`, `sync` (+187 more)
